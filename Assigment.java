...
//		}
		...
		// #24: TODO (Solve "63 в 21" with correct usage of WebDriverWait)
		...
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "63 в"));
		} catch (TimeoutException ex) {
			fail("\"в\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'lVjWed\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "63 в 2"));
		} catch (TimeoutException ex) {
			fail("\"2\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'N10B9\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "63 в 21"));
		} catch (TimeoutException ex) {
			fail("\"1\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'Pt8tGc\']")).click();
		...
		// #25: TODO (Solve "45 В 9" with correct usage of WebDriverWait)
		...
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "45 В"));
		} catch (TimeoutException ex) {
			fail("\"В\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'XoxYJ\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "45 В 9"));
		} catch (TimeoutException ex) {
		...
		// #26: TODO (Solve "72 В 10" with correct usage of WebDriverWait)
		driver.findElement(By.xpath("//div[@jsname=\'rk7bOd\']")).click();
		try {
		...
		driver.findElement(By.xpath("//div[@jsname=\'WxTTNd\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "72 В"));
		} catch (TimeoutException ex) {
			fail("\"В\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'N10B9\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "72 В 1"));
		} catch (TimeoutException ex) {
			fail("\"1\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'bkEvMb\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "72 В 10"));
		} catch (TimeoutException ex) {
		...
		// #27: TODO (Solve "log(58 в 6 В 2 - 74)" with correct usage of WebDriverWait)
		...
		driver.findElement(By.xpath("//div[@jsname=\'YovRWb\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 в"));
		} catch (TimeoutException ex) {
			fail("\"в\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'abcgof\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 в 6"));
		} catch (TimeoutException ex) {
			fail("\"6\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'WxTTNd\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 в 6 В"));
		} catch (TimeoutException ex) {
			fail("\"В\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'lVjWed\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 в 6 В 2"));
		} catch (TimeoutException ex) {
			fail("\"2\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'pPHzQc\']")).click();
		...
		driver.findElement(By.xpath("//div[@jsname=\'rk7bOd\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 в 6 В 2 - 7"));
		} catch (TimeoutException ex) {
			fail("\"7\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'xAP7E\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 в 6 В 2 - 74"));
		} catch (TimeoutException ex) {
			fail("\"4\" was not input.");
		}
		driver.findElement(By.xpath("//div[@jsname=\'Pt8tGc\']")).click(); 		
...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		// #37: TODO (Solve "63 в 21" with correct usage of ImplicitlyWait)
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'63 в \']"));
		} catch (NoSuchElementException ex) {
			fail("\"в\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname=\'lVjWed\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'63 в 2\']"));
		} catch (NoSuchElementException ex) {
			fail("\"2\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname=\'N10B9\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'63 в 21\']"));
		} catch (NoSuchElementException ex) {	
			fail("\"1\" was not input.");
		}
		...
		// #38: TODO (Solve "45 В 9" with correct usage of ImplicitlyWait)
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'45 В \']"));
		} catch (NoSuchElementException ex) {
			fail("\"В\" was not input.");
		}
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'45 В 9\']"));
		} catch (NoSuchElementException ex) {
			fail("\"9\" was not input.");
		}
		...
		// #39: TODO (Solve "72 В 10" with correct usage of ImplicitlyWait)
		driver.findElement(By.cssSelector("div[jsname=\'rk7bOd\']")).click();		
		try {
		...
		driver.findElement(By.cssSelector("div[jsname=\'WxTTNd\']")).click();		
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'72 В \']"));
		} catch (NoSuchElementException ex) {
			fail("\"В\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname=\'N10B9\']")).click();		
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'72 В 1\']"));
		} catch (NoSuchElementException ex) {
			fail("\"1\" was not input.");
		}
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'72 В 10\']"));
		} catch (NoSuchElementException ex) {	
			fail("\"0\" was not input.");
		}
		...
		// #40: TODO (Solve "log(58 в 6 В 2 - 74)" with correct usage of ImplicitlyWait)
		// HINT: you don't need the last parentheses
		...
		driver.findElement(By.cssSelector("div[jsname=\'YovRWb\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'log(58 в \']"));
		} catch (NoSuchElementException ex) {
			fail("\"в\" was not input.");
		}
		driver.findElement(By.cssSelector("div[jsname=\'abcgof\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'log(58 в 6\']"));
		} catch (NoSuchElementException ex) {
			fail("\"6\" was not input.");
		}
		driver.findElement(By.cssSelector("div[jsname=\'WxTTNd\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'log(58 в 6 В \']"));
		} catch (NoSuchElementException ex) {
			fail("\"В\" was not input.");
		}
		driver.findElement(By.cssSelector("div[jsname=\'lVjWed\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'log(58 в 6 В 2\']"));
		} catch (NoSuchElementException ex) {
			fail("\"2\" was not input.");
		}
		driver.findElement(By.cssSelector("div[jsname=\'pPHzQc\']")).click();
		...
		driver.findElement(By.cssSelector("div[jsname=\'rk7bOd\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'log(58 в 6 В 2 - 7\']"));
		} catch (NoSuchElementException ex) {
			fail("\"7\" was not input.");
		}
		driver.findElement(By.cssSelector("div[jsname=\'xAP7E\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'log(58 в 6 В 2 - 74\']"));
		} catch (NoSuchElementException ex) {
			fail("\"4\" was not input.");
		}		
		driver.findElement(By.cssSelector("div[jsname=\'Pt8tGc\']")).click();		
